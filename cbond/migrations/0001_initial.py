    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(max_length=9, verbose_name='转债代码')),
                ('full_name', models.CharField(max_length=50, verbose_name='转债名称')),
                ('short_name', models.CharField(max_length=30, verbose_name='转债简称')),
                ('stock_code', models.CharField(max_length=9, verbose_name='正股代码')),
                ('stock_name', models.CharField(max_length=50, verbose_name='正股简称')),
                ...
                ('issue_size', models.FloatField(verbose_name='发行总额（元）')),
                ('remain_size', models.FloatField(verbose_name='债券余额（元）')),
